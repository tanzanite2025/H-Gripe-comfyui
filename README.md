...
| [Subject Mask / Matte Editor](docs/cards/subject-mask-matte.md) | `subject_mask_cli.py` *(planned)* | Identify the subject and produce / hand-edit a mask, cutout and alpha (magic-wand + brush in Phase 1; SAM / matting later). |
