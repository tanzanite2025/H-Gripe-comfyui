  ...
  crop: {
    ...
    params: [
      ...
      },
      {
        ...
        control: "text",
        defaultValue: "",
        hint: "base name for the cropped PNG (empty = <image>_crop)",
        inline: true,
      },
    ],
  },
  ...
  imageEnhance: {
    ...
    params: [
      ...
      },
      {
        ...
        defaultValue: "auto",
        inline: true,
        hint: "compute device for the realesrgan upscaler: auto (cuda if present else cpu) | cpu | cuda (degrades to cpu without an accelerator); ignored by the cpu path",
